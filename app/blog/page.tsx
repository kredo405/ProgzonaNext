...
const Blog = () => {
    return (
        <>
            <Nav />
            <div className="mt-16">
                <div className="flex justify-around flex-col lg:flex-row bg-[#2a2e3a] text-orange-600 p-5 rounded-2xl mx-2 lg:mx-20">
                    <div>
                        <h1 className="text-3xl font-mono font-bold py-5">
                            Руководства по технологиям, инструментам и методикам
                            разработки
                        </h1>
