    ...
    return (
        <div className="flex flex-col w-full ">
            <div className="w-full">
                <div className="flex justify-between bg-[#1a1d25] w-full border-t-2 border-x-2 border-orange-900 rounded-t-2xl">
                ...
                /> */}
                <div className="z-0 border-b-2 border-x-2 border-orange-900 flex flex-col-reverse md:flex-row">
                    ...
                    <div className="flex flex-col justify-between bg-[#212122] w-full md:w-5/12">
                        <div>
